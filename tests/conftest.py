...
_CONFIG_ENV = [
    ...
    "SIGNAL_CONFLUENCE_TTL_SECONDS",
    "SAMPLE_COLLECTION_ENABLED",
    "SAMPLE_COLLECTION_FRAMES",
    "SAMPLE_COLLECTION_FRAME_SECONDS",
    "SAMPLE_COLLECTION_PATH",
    "ARBITRAGE_MONITOR_ENABLED",
    "ARBITRAGE_SIZE_SOL",
    "ARBITRAGE_MIN_NET_EDGE_BPS",
    "ARBITRAGE_INTERVAL_SECONDS",
    "EVM_EVALUATION_ENABLED",
    "EVM_CHAINS",
    "EVM_WATCHLIST",
    "EVM_INTERVAL_SECONDS",
    "EVM_MAX_TOKENS_PER_CYCLE",
    "EVM_USE_AI_BRAIN",
    "EVM_SAMPLE_COLLECTION_PATH",
    "EVM_SAFETY_ENABLED",
    "EVM_SAFETY_MAX_BUY_TAX_PCT",
    "EVM_SAFETY_MAX_SELL_TAX_PCT",
    "EVM_SAFETY_REQUIRE_LP_LOCKED",
    "EVM_SAFETY_FAIL_OPEN",
    "ALLOCATION_ENABLED",
    "ALLOCATION_WINDOW",
    "ALLOCATION_MIN_TRADES",
    "ALLOCATION_FLOOR_MULT",
    "ALLOCATION_CEILING_MULT",
    "PORTFOLIO_MAX_EXPOSURE_SOL",
    "PORTFOLIO_MAX_PER_CREATOR",
    "PORTFOLIO_LAUNCH_WINDOW_SECONDS",
    "PORTFOLIO_MAX_PER_WINDOW",
    "PORTFOLIO_MAX_DRAWDOWN_SOL",
    "WALLET_PRIVATE_KEYS",
    "WALLET_POOL_SIZE",
    "WALLET_BASE_FUNDING_SOL",
    "WALLET_STRATEGY_FUNDING",
    "WALLET_PRIVATE_KEY",
]
